"""Eleva um servomotor gradualmente ate o angulo escolhido.

Bloco correspondente: Subir servo.
"""
...
def subir_gradualmente(conexao, inicio=0, destino=180, passo=10, pausa=3):
    ...
    while angulo <= destino:
        ...
        if angulo >= destino:
            break
        angulo = min(angulo + passo, destino)


subir_gradualmente(conexao=0, inicio=0, destino=180, passo=10, pausa=3)
